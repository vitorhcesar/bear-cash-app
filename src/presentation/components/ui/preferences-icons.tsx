...
export function SoundNoteIcon({ size = 12, color }: IconProps) {
  return <FigmaSvgIcon xml={PREF_SOUND_XML} size={size} color={color} />;
}

export function VibrationPhoneIcon({ size = 12, color }: IconProps) {
  return <FigmaSvgIcon xml={PREF_VIBRATION_XML} size={size} color={color} />;
}

export function PreferenceRestoreIcon({ size = 12, color }: IconProps) {
  return <FigmaSvgIcon xml={PREF_RESTORE_XML} size={size} color={color} />;
}

export function BellIcon({ size = 12, color }: IconProps) {
...
export function SunIcon({ size = 12, color }: IconProps) {
  const stroke = useIconColor(color);
  return (
    <Svg width={size} height={size} viewBox="0 0 12 12" fill="none">
      <Circle cx={6} cy={6} r={2.15} stroke={stroke} />
      <Path d="M6 1.25V2.15" stroke={stroke} strokeLinecap="round" />
      <Path d="M6 9.85V10.75" stroke={stroke} strokeLinecap="round" />
      <Path d="M1.25 6H2.15" stroke={stroke} strokeLinecap="round" />
      <Path d="M9.85 6H10.75" stroke={stroke} strokeLinecap="round" />
      <Path d="M2.64 2.64L3.28 3.28" stroke={stroke} strokeLinecap="round" />
      <Path d="M8.72 8.72L9.36 9.36" stroke={stroke} strokeLinecap="round" />
      <Path d="M9.36 2.64L8.72 3.28" stroke={stroke} strokeLinecap="round" />
      <Path d="M3.28 8.72L2.64 9.36" stroke={stroke} strokeLinecap="round" />
    </Svg>
  );
}
