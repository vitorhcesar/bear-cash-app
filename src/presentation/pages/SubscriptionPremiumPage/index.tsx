...
const PREMIUM_CONTENT = {
  ...
  yearly: {
    ...
    badge: '-14%',
    badgeColor: BearCashColors.premiumGold,
  },
  monthly: {
    title: 'Mensal',
  ...
  reviews: [
    {
      ...
      body: 'O BearCash Premium mudou minha relação com o dinheiro. O suporte 24/7 e os relatórios em PDF são simplesmente fantásticos e muito práticos.',
